...
public class NumTypeTester
{
	...
	int verylargeint = 2100000000; // se verylargeint ha un valore vicino a
                                  ...
                                  /*RISPOSTA: POICHE' IL MASSIMO VALORE CHE UNA VARIABILE DI 
                                    TIPO INT PUO' ASSUMERE E' 2^31 (2147483648)
                                  */
	...
	// int smallint = smalldouble; //cosi` non funziona (provare). Perche`? 
	                               /*RISPOSTA: POICHE' SI STA CERCANDO DI ATTRIBUIRE UN VALORE
	                                 DI TIPO DOUBLE AD UNA VARIABILE DI TIPO INT, LA QUALE NON
	                                 HA UNA PARTE DECIMALE
	                               */
	...
	// smallint = Math.round(smalldouble); //cosi` non funziona (provare).
	                                       // Perche`?
	                                       /*RISPOSTA: POICHE' NON E' POSSIBILE ASSEGNARE UN
	                                          VALORE DI TIPO LONG AD UNA VARIABILE DI TIPO INT
	                                       */
	...
	int largeint = (int) largedouble; // se largedouble e` piu` grande di
	                                  ...
	                                  // produce un risultato inaspettato.
                                          // Perche`?.
                                     /*RISPOSTA: POICHE' IL MASSIMO VALORE CHE PUO' ASSUMERE 
                                       UNA VARIABILE DI TIPO DOUBLE E' 1.7976931348623157E308
                                       (controllare quale e' minore)
                                     */
